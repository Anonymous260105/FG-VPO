...
def get_args():
    ...
    parser.add_argument('--evaluation_type', choices=['a', 'g', 'd', 'de', 'da', 'dr'], 
                       help='a: all tasks and dimensions, g: generative task, d: discriminative task, de/da/dr: existence/attribute/relation')
...
def main(args):
    ...
    # Load inference data (JSONL format)
    inference_data = []
    ...
    for i in tqdm(range(len(inference_data))):
        ...
        if ground_truth[id-1]['type'] == 'generative':
            ...
            # Build safe words list with indices
            safe_words = []
            safe_list = []
            ...
            # Build hallucination words list with indices
            ha_words = []
            ha_list = []
            ...
            # Add original ground truth words
            ...
            # Check each noun against safe and hallucination words
            for idx, noun in enumerate(after_process_nouns):
                ...
                # Check for synonyms with hallucination words
                ...
                # Check for synonyms with safe words
                flag = False
            ...
            # Update metrics for generative task
            ...
            # Discriminative task evaluation
    ...
    # Calculate repetition ratio (long responses)
    count = 0
